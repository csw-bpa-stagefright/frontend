            ...
            <div className="w-full">
                <div className="relative w-full h-[100px] mb-5 max-h-[100px]">
                    ...
                    <div className="rounded-lg menuitemimage object-cover hover:!blur-[0.5px] hover:!scale-[0.995] hover:!opacity-90 transition-all duration-100 h-full flex items-center justify-center bg-neutral-50 flex-col gap-3">
                        ...
                        <div role="status">
                            <svg aria-hidden="true" className="w-6 h-6 text-neutral-200 animate-spin  fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex mt-3 gap-0 w-full items-center justify-start relative h-[30px]">
                    ...
                    <button onClick={deleteMenuItem} className="p-2.5 cursor-pointer hover:bg-red-700 ml-5 bg-red-600 rounded-full">
                        <Trash2
                            size={17}
                            color="white"
                        />
                ...
                <p className="text-sm font-semibold text-red-700 mt-4">${parseFloat(item.itemPrice).toFixed(2)}</p>
            </div>
        </>
    )
}
